package com.tugasday1.app_nurafnisyahfitri1.activity;
...
import com.tugasday1.app_nurafnisyahfitri1.R;
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (password.getText().toString().toUpperCase().equals("AFNI01")){
                   login_sukses();
                }else {
